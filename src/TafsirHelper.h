...
public:
    ...
    Q_INVOKABLE QVariantMap addSuite(qint64 author, qint64 translator, qint64 explainer, QString const& title, QString const& displayName, QString const& description, QString const& reference, bool isBook);
    ...
    Q_INVOKABLE QVariantMap editSuite(QObject* caller, qint64 id, qint64 author, qint64 translator, qint64 explainer, QString const& title, QString const& displayName, QString const& description, QString const& reference, bool isBook);
    ...
    Q_INVOKABLE void fetchAllQuotes(QObject* caller, qint64 id=0, qint64 author=0, qint64 suiteId=0, int limit=200);
    Q_INVOKABLE void fetchAllTafsir(QObject* caller, qint64 id=0, qint64 author=0, int limit=200);
    ...
    Q_INVOKABLE void replaceSuite(QObject* caller, qint64 toReplaceId, qint64 actualId);
